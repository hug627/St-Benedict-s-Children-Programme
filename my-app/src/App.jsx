...
const SUCCESS_STORIES = [
  {
    ...
    name: "Esther Novins",
    achievement:
      "University Graduate — Bachelor's Degree in Occupational Therapy",
    story:
      "Esther studied at the Presbyterian University, where she attained her Degree in Occupational Therapy.",
  },
  {
    photo: "/img_8.jpeg",
    name: "Miriam Bosibori",
    achievement:
      "University Graduate — Bachelor's Degree in Education",
    story:
      "Miriam studied at Kisii University, where she attained her degree in Education in 2025.",
  },
  {
    photo: "/img_19.jpeg",
    name: "James Ngigi",
    ...
    story:
      "James studied at Masinde Muliro University and graduated with a degree in Criminology in 2022.",
  },
  {
    photo: "/img_20.jpeg",
    ...
    story:
      "Hesbon studied at the University of Nairobi, completing his Degree in Business Management in 2022.",
  },
  {
    photo: "/img_21.jpeg",
    name: "Lilian Owuor",
    achievement:
      "University Graduate — Degree in Business Administration and Economics",
    story:
      "Lilian studied at Mount Kenya University, earning her degree in Business Administration and Economics in 2026.",
  },
  {
    photo: "/img_22.jpeg",
    name: "Stephen Omondi",
    ...
    story:
      "Stephen studied at Jomo Kenyatta University, attaining his degree in Entrepreneurship in 2020.",
  },
  {
    photo: "/img_29.jpeg",
    name: "Stephen Nkalovwe",
    achievement:
      "University Graduate — Degree in Analytical Chemistry",
    story:
      "Stephen studied at Jomo Kenyatta University, attaining his Degree in Analytical Chemistry in 2021.",
  },
  {
    photo: "/img_30.jpeg",
    name: "Walter Oketch",
    ...
    story:
      "Walter studied at the Kenya Institute of Survey and Mapping, attaining his Diploma in Photogrammetry and Remote Sensing in 2019.",
  },
  {
    photo: "/img_25.jpeg",
    name: "Julius Mutisya",
    ...
    story:
      "Julius studied at the East African Institute, attaining his Diploma in Social Work in 2018.",
  },
  {
    photo: "/img_26.jpeg",
    name: "Peter Kioko",
    ...
    story:
      "Peter studied at the Technical University of Kenya, attaining his Diploma in Medical Records in 2019.",
  },
  {
    photo: "/img_27.jpeg",
    ...
    achievement: "Diploma in Social Work",
    story:
      "Stephine studied at the East African Institute, attaining her Diploma in Social Work in 2018.",
  },
  {
    photo: "/img_28.jpeg",
    ...
    story:
      "Patrick studied at Taita Taveta University, attaining his Degree in Statistics in 2018.",
  },
];
...
function toneClasses(tone) {
  return tone === "dark"
    ? "bg-[#2F0F03] text-[#FFDDAC]"
    : "bg-[#FFDDAC] text-[#2F0F03]";
}
...
// ---------------------------------------------------------------------------
// Section
// Generic content block with scroll-triggered animation
// ---------------------------------------------------------------------------
...
function Section({
    ...
    () => {
      const animatedTargets =
        sectionRef.current.querySelectorAll(
          ".animate-in, .animate-in li, .section-img-item"
        );
      ...
      const imgTargets =
        sectionRef.current.querySelectorAll(".section-img-item");
  ...
  return (
    <section
      ...
      ref={sectionRef}
      className={`${
        customStyle ? "" : toneClasses(tone)
      } font-body scroll-mt-20 px-6 py-20 md:px-16`}
      style={customStyle}
    >
      <div
        className={`mx-auto max-w-6xl ${
          hasImages
            ? "grid items-start gap-8 md:grid-cols-2 md:gap-12"
            : "max-w-3xl"
        }`}
      >
        <div
          className={
            hasImages && activePosition === "left"
              ? "md:order-2"
              : "md:order-1"
          }
        >
          ...
          <h2
            ref={titleRef}
            className="font-display mb-6 text-3xl font-semibold md:text-4xl"
          >
            {title}
          </h2>

          <div className="animate-in space-y-4 text-base leading-relaxed opacity-90 md:text-lg">
            {children}
          </div>
        </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <h2
          ref={titleRef}
          className="font-display mb-4 max-w-2xl text-3xl font-semibold md:text-4xl"
        >
          {title}
        </h2>

        <p className="mb-12 max-w-2xl text-base opacity-80 md:text-lg">
          Young people who grew up in our programme and went on to
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <h2
          ref={titleRef}
          className="font-display mb-10 text-3xl font-semibold md:text-4xl"
        >
          {title}
        </h2>
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 md:gap-4">
          {images.map((img) => (
            <div
              key={img.src}
              className="gallery-img aspect-square overflow-hidden rounded-xl shadow-md"
            >
              <img
                src={img.src}
                alt={img.alt || ""}
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="relative w-full max-w-md rounded-2xl bg-[#2F0F03] p-6 text-[#FFDDAC] shadow-2xl ring-1 ring-[#FAAA48]/30">
        ...
        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#FAAA48]">
          Make a Difference
        </p>

        <h3 className="font-display my-2 text-2xl font-bold">
          Support Our Programme
        </h3>

        <p className="mb-6 text-sm opacity-80">
          Your contribution helps provide basic needs, education,
          and shelter to street children in Mathare.
        </p>

        <div className="space-y-4 rounded-xl bg-[#240c02] p-4 text-left">
          <div>
            <p className="text-xs font-medium uppercase text-[#FAAA48]">
              Mpesa Paybill
            </p>

            <p className="text-lg font-bold">
              {DONATION_INFO.mpesaPaybill}
            </p>
          </div>
  ...
  useGSAP(
    () => {
      ...
      tl.from(split.chars, {
        ...
        [...heroRef.current.children].filter(
          (el) => el !== heroTitleRef.current
        ),
        {
          opacity: 0,
          y: 24,
    ...
    <div className="font-body overflow-x-hidden">
      ...
      <div className="bg-[#240c02] px-4 py-1.5 text-xs text-[#FFDDAC] sm:px-6 md:px-10">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-4">
            <span className="hover:text-[#FAAA48]">
              Get in touch
            </span>
      ...
      <header
        className={`sticky top-0 z-50 w-full transition-colors duration-300 ${
          scrolled
            ? "bg-[#2F0F03]/95 backdrop-blur shadow-md"
            : "bg-[#2F0F03]"
        }`}
      >
                ...
                {accountMenuOpen && (
                  <div className="absolute right-0 top-full mt-3 w-48 overflow-hidden rounded-xl bg-[#2F0F03] shadow-xl ring-1 ring-[#FAAA48]/20">
                    <div className="border-b border-[#FAAA48]/20 px-4 py-3">
                      <p className="truncate text-sm font-semibold text-[#FFDDAC]">
                        {user.name}
                      </p>

                      <p className="truncate text-xs text-[#FFDDAC]/60">
                        {user.email}
                      </p>
                    </div>
        ...
        >
          <div className="flex max-h-[70vh] flex-col gap-1 overflow-y-auto overflow-x-hidden px-6 pb-4">
            ...
            <div className="mt-2 border-t border-[#FAAA48]/20 pt-2">
              {user ? (
                <>
                  <p className="truncate py-1 text-xs text-[#FFDDAC]/60">
                    {user.email}
                  </p>
      ...
      >
        <div className="relative" ref={heroRef}>
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.3em] text-[#FAAA48]">
            Welcome
          </p>

          <h1
            ref={heroTitleRef}
            className="font-display max-w-2xl text-3xl font-semibold leading-tight sm:text-4xl md:text-6xl"
          >
            St Benedict's Children Programme
          </h1>

          <p className="mt-6 max-w-xl font-body text-base opacity-80 sm:text-lg">
            A rehabilitation centre for boys living on the
            street.
          </p>
      ...
      >
        <p>
          St. Benedict's Children Programme is the brainchild of
          the Kolping Family and St. Benedict's Catholic Parish,
          Ruaraka. The idea for its formation can be traced back
          to 1993, when a group of foresighted individuals led by
          Fr. Klaus Braunreter OSB, then parish priest of St.
          Benedict's Nairobi, set out to help under-privileged
          children and young people.
        </p>

        <p>
          A government survey shows there are about 100,000
          street children in Nairobi, with at least 30% living in
          Mathare and its adjacent slums — a large part of which
          falls under the jurisdiction of St. Benedict's Parish.
          Care and protection of the child is a matter of ongoing
          global concern, addressed through various UN conventions
          and assemblies. St. Benedict's Children Programme has
          been part of implementing those conventions, directly and
      ...
      >
        <p>
          St Benedict's Children Centre is located in Mathare
          North Area 2, near Mathare North Primary School and
      ...
      >
        <p>
          A stable, responsible and morally upright child in
          society.
        </p>
      </Section>
      ...
      >
        <p>
          St. Benedict's Children Programme is a church-based
          initiative that provides a strong foundation for children
          — within the context of family and community — to become
          educated, self-reliant and responsible, by involving the
          family and community in providing basic needs:
        </p>
      ...
      >
        <p>
          To provide a foundation for new life for street children
          and other under-privileged children — a healthy home,
          parental care, schooling, food and primary health care,
      ...
      >
        <ul className="list-disc space-y-2 pl-5">
          <li>
            Making contact with children's families, referral
            process and recruiting children
          </li>

          <li>
            Day care centre and non-formal primary education
          </li>

          <li>
            Recreation (art, music, sports, storytelling and poems)
          </li>

          <li>Counselling and guidance</li>

          <li>
            Integrating Christian morals and values with the
            children's family and community
          </li>

          <li>
            Helping families place their children into educational
            institutions or vocational training
          </li>

          <li>
            Home visits, school visits and follow-ups
          </li>
          ...
          <li>
            Library and literacy activities serving the entire
            Mathare slum community for free
          </li>

          <li>
            Street children rehabilitation, reintegration and
            school sponsorship from primary school through
            university level
          </li>
      ...
      >
        <p className="mb-8 max-w-3xl">
          The Centre relies on three main donors whose generous
          support helps us continue providing care, education,
          rehabilitation and opportunities for the children and
          young people in our programme.
        </p>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="group rounded-2xl bg-[#2F0F03] p-6 text-[#FFDDAC] shadow-lg ring-1 ring-[#FAAA48]/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <p className="text-sm leading-relaxed opacity-85">
              Kinder-Initiative Kenia (KIK) from Germany is one of
              the Centre's main donors, supporting the continued
              care, education and development of the children in
              our programme.
            </p>
          </div>

          {/* ===============================================================
              DONOR 2 - ST BENEDICT'S PARISH
          =============================================================== */}
          ...
          <div className="group rounded-2xl bg-[#2F0F03] p-6 text-[#FFDDAC] shadow-lg ring-1 ring-[#FAAA48]/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <p className="text-sm leading-relaxed opacity-85">
              St. Benedict's Parish, which is the host of the
              Centre, is one of the main supporters of the
              programme and plays an important role in sustaining
              the Centre's work.
            </p>
          </div>

          {/* ===============================================================
              DONOR 3 - WELL WISHERS
          =============================================================== */}
          ...
          <div className="group rounded-2xl bg-[#2F0F03] p-6 text-[#FFDDAC] shadow-lg ring-1 ring-[#FAAA48]/20 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <p className="text-sm leading-relaxed opacity-85">
              The Centre also receives generous support from
              well-wishers, friends and individuals who believe in
              our mission and contribute towards improving the
              lives and future of the children we serve.
            </p>
          </div>
        </div>
      </Section>
      ...
      <footer className="bg-[#FFDDAC] px-4 py-10 text-[#2F0F03] sm:px-6 md:px-16">
        <div className="mx-auto max-w-3xl space-y-6 text-center">
          ...
          <p className="text-xs opacity-70">
            © {new Date().getFullYear()} St Benedict's Children
